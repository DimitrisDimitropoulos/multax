...
def main():
    ...
    db_path = "cylinder_chunked_warp.h5"
    ...
    generate_orchestrated_video(
        db_path=db_path,
        output_path="cylinder_flow_orchestrator_warp.mp4",
        config=config,
        t_eval=t_eval,
        bounds=flat_bounds,
        flow_func=flow_cylinder_potential,
        ...
        fps=60,
        slow_mo_factor=5.0,
        use_warp=True,  # Set to True to test Warp rasterizer!
    )
    print("Done.")
